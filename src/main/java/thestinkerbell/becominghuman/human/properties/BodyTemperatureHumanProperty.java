...
public class BodyTemperatureHumanProperty extends HumanProperty {
	...
	public BodyTemperatureHumanProperty() {
		...
		this.risk_factors.add(new RiskFactor(BodyTemperatureRisk.BODYTEMPERATURE_VERYCOLD, -273, 31));
		this.risk_factors.add(new RiskFactor(BodyTemperatureRisk.BODYTEMPERATURE_COLD, 32, 35));
		this.risk_factors.add(new RiskFactor(BodyTemperatureRisk.BODYTEMPERATURE_NORMAL, 36, 38));
		this.risk_factors.add(new RiskFactor(BodyTemperatureRisk.BODYTEMPERATURE_WARM, 39, 42));
		this.risk_factors.add(new RiskFactor(BodyTemperatureRisk.BODYTEMPERATURE_VERYWARM, 43, 980));
	}
