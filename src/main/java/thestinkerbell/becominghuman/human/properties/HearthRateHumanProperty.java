...
public class HearthRateHumanProperty extends HumanProperty {
	...
	public HearthRateHumanProperty() {
		...
		this.risk_factors.add(new RiskFactor(HeartRateRisk.HR_LOW, 0, 49));
		this.risk_factors.add(new RiskFactor(HeartRateRisk.HR_NORMAL, 50, 90));
		this.risk_factors.add(new RiskFactor(HeartRateRisk.HR_HIGH, 91, 220));
	}
