...
public class BloodPressureCompoundHumanProperty extends PairedCompoundHumanProperty<SystolicBloodPressureBasicHumanProperty, DiastolicBloodPressureBasicHumanProperty> {
	...
	public BloodPressureCompoundHumanProperty(SystolicBloodPressureBasicHumanProperty systolic, DiastolicBloodPressureBasicHumanProperty diastolic) {
		...
		this.risk_ranges.add(new RiskRange(BloodPressureRisk.BP_HYPOTENSION, new Pair(0.0, 0.0), new Pair(90.0, 60.0)));
		this.risk_ranges.add(new RiskRange(BloodPressureRisk.BP_DESIRED, new Pair(91.0, 61.0), new Pair(119.0, 79.0)));
		this.risk_ranges.add(new RiskRange(BloodPressureRisk.BP_PREHYPERTENSION, new Pair(120.0, 80.0), new Pair(139.0, 89.0)));
		this.risk_ranges.add(new RiskRange(BloodPressureRisk.BP_STAGE1HYPERTENSION, new Pair(140.0, 90.0), new Pair(159.0, 99.0)));
		this.risk_ranges.add(new RiskRange(BloodPressureRisk.BP_STAGE2HYPERTENSION, new Pair(160.0, 100.0), new Pair(179.0, 109.0)));
		this.risk_ranges.add(new RiskRange(BloodPressureRisk.BP_HYPERTENSIVEURGENCY, new Pair(180.0, 110.0), new Pair(340.0, 190.0)));
	}
