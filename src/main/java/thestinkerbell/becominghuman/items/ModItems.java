...
import thestinkerbell.becominghuman.items.debug.HumanPropertiesTryPotionEffect;
...
public final class ModItems {
	...
	private static void registerDebugItems() {
    	...
    	HumanPropertiesTryPotionEffect try_potion_effect_item = new HumanPropertiesTryPotionEffect();
    	
    	output_item.setCycleItem(cycle_item);
    	decrease_item.setCycleItem(cycle_item);
    	increase_item.setCycleItem(cycle_item);
    	try_potion_effect_item.setCycleItem(cycle_item);
    	...
    	GameRegistry.registerItem(try_potion_effect_item.setUnlocalizedName("try_potion_effect_item").setCreativeTab(CreativeTabs.tabMisc), "try_potion_effect_item");
	}
